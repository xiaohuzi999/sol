...
module ui.main {
    export class MainMenuViewUI extends View {
        ...
        public static  uiView:any ={"type":"View","props":{"width":750,"height":200},"child":[{"type":"Image","props":{"y":0,"x":340,"skin":"main/btn_role.png"}},{"type":"Image","props":{"y":0,"x":74,"skin":"main/btn_ranking.png"}},{"type":"Image","props":{"y":0,"x":615,"skin":"main/btn_card.png"}},{"type":"Label","props":{"y":120,"x":81,"text":"排行榜","fontSize":25,"color":"#ffffff","align":"center"}},{"type":"Label","props":{"y":120,"x":360,"text":"角色","fontSize":25,"color":"#ffffff","align":"center"}},{"type":"Label","props":{"y":120,"x":610,"text":"音乐卡片","fontSize":25,"color":"#ffffff","align":"center"}}]};
        constructor(){ super()}
        createChildren():void {
